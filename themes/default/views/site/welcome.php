...
<div class="row">
	<div class="span6">
		...
		<p>
			<div class="alert">
			  <button type="button" class="close" data-dismiss="alert">&times;</button>
			  <strong></strong>Если вы хотете создать откуртый конкурс для всех специалистов
			  зарегистрированных на нешем сайте - воспользуйтесь формой ниже.
			</div>
	...
	<div class="span6">
		...
		<div class="alert">
		  <button type="button" class="close" data-dismiss="alert">&times;</button>
		  <strong></strong>Если вы мастер строительных и ремонтных работа, то зарегистрируйтесь
