	...
	<div class="span9">
		...
		<div class="tab-content">
		  	<div class="tab-pane active" id="client">
		  		...
		  		создавать заказы для сложных и уникальных проектов. 
		  		</p>
		  	...
		  	<div class="tab-pane" id="spec">
		  		<p>
		  			...
		  			в конкурсах за заказы &ndash; сложные, уникальные и дорогие проекты.
		  		</p>
		  		<form class="form-horizontal">
					<div class="control-group">
				    	<label class="control-label" for="inputName">Ваше имя*</label>
				 	...
				 	<div class="control-group">
				  	...
				  	<div class="control-group">
				    	<div class="controls">
				      	<label class="checkbox">
								<input type="checkbox" value=""> Получать email-уведомления о новых <a href="#">заказах</a>
							</label>
				    	</div>
				  	</div>
